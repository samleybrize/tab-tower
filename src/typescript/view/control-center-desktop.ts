...
async function main() {
    ...
    commandBus.register(CloseOpenedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    commandBus.register(DeleteRecentlyUnfollowedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    commandBus.register(DuplicateOpenedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    commandBus.register(FocusOpenedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    ...
    commandBus.register(MuteOpenedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    commandBus.register(PinOpenedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    commandBus.register(ReloadOpenedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    ...
    commandBus.register(UnmuteOpenedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    commandBus.register(UnpinOpenedTab, sendMessageCommandHandler.onCommand, sendMessageCommandHandler);
    ...
    eventBus.subscribe(OpenedTabClosed, followedTabView.onTabClose, followedTabView);
    eventBus.subscribe(OpenedTabClosed, openedTabView.onTabClose, openedTabView);
    eventBus.subscribe(TabOpened, openedTabView.onTabOpen, openedTabView);
    eventBus.subscribe(OpenedTabFollowed, followedTabView.onTabFollow, followedTabView);
    eventBus.subscribe(OpenedTabFollowed, openedTabView.onTabFollow, openedTabView);
