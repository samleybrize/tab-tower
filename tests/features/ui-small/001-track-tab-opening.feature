...
Feature: Track tab opening
    ...
    Scenario: Opened tabs should appear in the opened tabs list
        ...
        And I should see the test page "test-page-with-not-found-favicon" as tab 2 on the tab list "opened-tabs"
        And I should see the test page "test-page-without-favicon" as tab 3 on the tab list "opened-tabs"
        And I should see the test page "test-page-with-favicon-401" as tab 4 on the tab list "opened-tabs"
        And I should see the current tab list with label "All opened tabs" and 6 tabs indicated

        And I should see the url "about:newtab" on the tab 5 of the tab list "opened-tabs"
        And I should see the url domain "about:newtab" on the tab 5 of the tab list "opened-tabs"
