...
Feature: Settings - Tab close button on hover
    ...
    Scenario: Tab close button should be shown on hover
        ...
        When I hover the tab 1 on the workspace "opened-tabs"

        Then there should be a visible close button on the tab 1 on the workspace "opened-tabs"
    ...
    Scenario: Pinned tab close button should not be shown on hover
        ...
        When I hover the tab 0 on the workspace "pinned-tabs"

        Then there should not be a visible close button on the tab 0 on the workspace "pinned-tabs"
    ...
    Scenario: Uncheck tab close button on hover setting should prevent the tab close button to be shown on hover
        ...
        And I hover the tab 3 on the workspace "opened-tabs"

        Then there should not be a visible close button on the tab 3 on the workspace "opened-tabs"
    ...
    Scenario: Check tab close button on hover setting should allow the tab close button to be shown on hover
        ...
        Then there should be a visible close button on the tab 3 on the workspace "opened-tabs"
    ...
    Scenario: Check tab close button on hover setting should prevent the pinned tab close button to be shown on hover
        ...
        When I focus the small UI
        And I hover the tab 0 on the workspace "pinned-tabs"

        Then there should not be a visible close button on the tab 0 on the workspace "pinned-tabs"

        When I open the test page "test-page2"
        And I pin the tab 3
        And I hover the tab 1 on the workspace "pinned-tabs"

        Then there should not be a visible close button on the tab 1 on the workspace "pinned-tabs"
