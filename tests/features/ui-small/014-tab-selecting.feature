...
Feature: Tab selecting
    ...
    Scenario: Clicking on an off opened tab selector with shift pressed should check visible selectors from it to the last clicked
        ...
        And I should not see the filtered tab 0 as selected on the workspace "opened-tabs"
    ...
    Scenario: Clicking on an on opened tab selector with shift pressed should uncheck visible selectors from it to the last clicked
        ...
        And I click on the tab selector of the tab 4 on workspace "opened-tabs"

        When I type "page tab" in the tab filter input

        Then I should see 4 visible tabs on the workspace "opened-tabs"

        When I shift click on the tab selector of the tab 1 on workspace "opened-tabs"
        ...
        And I should see the filtered tab 0 as selected on the workspace "opened-tabs"
