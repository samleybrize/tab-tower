...
Feature: Selected tabs actions
    ...
    Scenario: Hovering a tab when a context menu is opened should not reveal its close button or its tab selector
        ...
        Then there should not be a visible close button on the tab 0 on the tab list "opened-tabs"
        And the tab selector of the tab 0 on the tab list "opened-tabs" should not be visible
