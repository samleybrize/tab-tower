...
// TODO duplicate of SidenavTabTagFilter
export class TabTagAssignFilter {
...
export class TabTagAssignFilterFactory {
    constructor(private queryBus: QueryBus) {
    }

    create(containerElement: HTMLElement) {
        return new TabTagAssignFilter(containerElement, this.queryBus);
    }
}
