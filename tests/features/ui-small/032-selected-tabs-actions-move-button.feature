...
Feature: Selected tabs actions - Move button
    ...
    Scenario: A click on the selection move button should reveal move targets
        When I click on the tab selector of the tab 2 on workspace "opened-tabs"
    ...
    Scenario: A click on the selection move button should highlight selected tab rows
        ...
        And I should see the tab 2 as being moved on the workspace "opened-tabs"
        And I should see the tab 3 as being moved on the workspace "opened-tabs"
    ...
    Scenario: A click on "move above" should move selected pinned tab rows above the clicked row when they are lower than it
        ...
        When I click on the tab selector of the tab 2 on workspace "pinned-tabs"
        And I click on the tab selector of the tab 3 on workspace "pinned-tabs"
        And I click on the selected tabs actions move button
        ...
        And I should not see the move above button on the tab 3 on the workspace "pinned-tabs"
        And the move below all button should not be visible
    ...
    Scenario: A click on "move above" should move selected tab rows above the clicked row when they are higher than it
        ...
        And I click on the selected tabs actions move button
        And I click on the move above button of the tab 4 on the workspace "opened-tabs"
        ...
        And I should not see the move above button on the tab 2 on the workspace "opened-tabs"
        And I should not see the move above button on the tab 3 on the workspace "opened-tabs"
        And I should not see the move above button on the tab 4 on the workspace "opened-tabs"
        And the move below all button should not be visible
    ...
    Scenario: A click on "move above" should move selected pinned tab rows above the clicked row when they are higher than it
        ...
        When I click on the tab selector of the tab 1 on workspace "pinned-tabs"
        And I click on the tab selector of the tab 2 on workspace "pinned-tabs"
        And I click on the selected tabs actions move button
        And I click on the move above button of the tab 4 on the workspace "pinned-tabs"
        ...
        And I should see the test page "test-filter1" as tab 3 on the workspace "pinned-tabs"
        ...
        And I should not see the move above button on the tab 2 on the workspace "pinned-tabs"
        And I should not see the move above button on the tab 3 on the workspace "pinned-tabs"
        And I should not see the move above button on the tab 4 on the workspace "pinned-tabs"
        And the move below all button should not be visible
    ...
    Scenario: A click on "move above" with pinned and unpinned tabs selected should move tabs that can go to the new position
        ...
        And I click on the tab selector of the tab 3 on workspace "opened-tabs"
        And I click on the selected tabs actions move button
        And I click on the move above button of the tab 2 on the workspace "opened-tabs"

        Then I should see the small UI as tab 0 on the workspace "opened-tabs"
        And I should see the test page "test-filter1" as tab 1 on the workspace "opened-tabs"
        And I should see the test page "test-filter-with-other-text" as tab 2 on the workspace "opened-tabs"
        ...
        And I click on the title of the tab 1 on the workspace "pinned-tabs"
