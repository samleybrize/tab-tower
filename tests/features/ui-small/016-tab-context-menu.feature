...
Feature: Tab context menu
    ...
    Scenario: A right click on a tab title should show the context menu
        When I right click on the title of the tab 1 on the tab list "opened-tabs"

        Then the context menu of the tab 0 on the tab list "opened-tabs" should not be visible
        And the context menu of the tab 1 on the tab list "opened-tabs" should be visible

    Scenario: A right click on a pinned tab title should show the context menu
        When I pin the tab 1
        And I right click on the title of the tab 0 on the tab list "pinned-tabs"

        Then the context menu of the tab 0 on the tab list "opened-tabs" should not be visible
        And the context menu of the tab 0 on the tab list "pinned-tabs" should be visible
    ...
    Scenario: The context menu of a tab should be hidden when any tab is closed
        ...
        Then I right click on the title of the tab 1 on the tab list "opened-tabs"
    ...
    Scenario: The context menu of a tab should be hidden when any tab is moved
        ...
        Then the context menu of the tab 0 on the tab list "opened-tabs" should not be visible
        Then the context menu of the tab 1 on the tab list "opened-tabs" should not be visible
        Then the context menu of the tab 2 on the tab list "opened-tabs" should not be visible
    ...
    Scenario: No element should be clickable when a context menu is opened
        ...
        When I click where the title of the tab 1 on the tab list "opened-tabs" is
    ...
    Scenario: Hovering a tab when a context menu is opened should not reveal its close button or its tab selector
        ...
        And the tab selector of the tab 1 on the tab list "opened-tabs" should not be visible
