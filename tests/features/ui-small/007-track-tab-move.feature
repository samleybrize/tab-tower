...
Feature: Track tab move
    ...
    Scenario: A moved tab should appear at its new position (forward)
        ...
        And I should see the tab 3 as focused on the tab list "opened-tabs"
    ...
    Scenario: A moved pinned tab should appear at its new position (forward)
        ...
        And I should see the test page "test-page1" as tab 2 on the tab list "pinned-tabs"
        ...
        And I should see the tab 2 as focused on the tab list "pinned-tabs"
        And I should not see the tab 3 as focused on the tab list "pinned-tabs"
    ...
    Scenario: A moved pinned tab should appear at its new position (backward)
        ...
        And I should see the test page "test-filter-with-some-text" as tab 3 on the tab list "pinned-tabs"
        And I should not see the tab 0 as focused on the tab list "opened-tabs"
        And I should see the tab 0 as focused on the tab list "pinned-tabs"
        And I should not see the tab 1 as focused on the tab list "pinned-tabs"
        And I should not see the tab 2 as focused on the tab list "pinned-tabs"
        And I should not see the tab 3 as focused on the tab list "pinned-tabs"
    ...
    Scenario: A moved tab should appear at its new position (multiple)
        ...
        And I should not see the tab 3 as focused on the tab list "opened-tabs"
        And I should not see the tab 4 as focused on the tab list "opened-tabs"
    ...
    Scenario: A moved pinned tab should appear at its new position (multiple)
        ...
        And I should see the tab 2 as focused on the tab list "pinned-tabs"
        And I should not see the tab 3 as focused on the tab list "pinned-tabs"
        And I should not see the tab 4 as focused on the tab list "pinned-tabs"
    ...
    Scenario: A moved tab should appear at its new position after a tab was closed
        ...
        Then I should see 4 visible tab on the tab list "opened-tabs"
