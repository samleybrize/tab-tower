...
Feature: Tab context menu - Move button
    ...
    Scenario: Clicking on a pinned tab context menu move button should reveal move targets
        ...
        Then I should see 3 visible tabs on the tab list "pinned-tabs"

        When I click on the tab context menu move button of the tab 1 on the tab list "pinned-tabs"

        Then I should see the move above button on the tab 0 on the tab list "pinned-tabs"
    ...
    Scenario: Clicking on a tab context menu move button should highlight the tab being moved
        ...
        And I should see the tab 1 as being moved on the tab list "opened-tabs"
    ...
    Scenario: Clicking on a pinned tab context menu move button should highlight the tab being moved
        ...
        Then I should not see the tab 0 as being moved on the tab list "pinned-tabs"
        And I should see the tab 1 as being moved on the tab list "pinned-tabs"
        And I should not see the tab 2 as being moved on the tab list "pinned-tabs"
    ...
    Scenario: Clicking on "move above" should move the tab above the clicked tab when the former is lower than the latter
        When I click on the tab context menu move button of the tab 3 on the tab list "opened-tabs"
    ...
    Scenario: Clicking on "move above" should move the pinned tab above the clicked tab when the former is lower than the latter
        ...
        When I click on the tab context menu move button of the tab 2 on the tab list "pinned-tabs"
    ...
    Scenario: Clicking on "move above" should move the tab above the clicked tab when the former is higher than the latter
        When I click on the tab context menu move button of the tab 1 on the tab list "opened-tabs"
        And I click on the move above button of the tab 3 on the tab list "opened-tabs"
    ...
    Scenario: Clicking on "move above" should move the pinned tab above the clicked tab when the former is higher than the latter
        ...
        When I click on the tab context menu move button of the tab 0 on the tab list "pinned-tabs"
        And I click on the move above button of the tab 2 on the tab list "pinned-tabs"

        Then I should see the small UI as tab 0 on the tab list "opened-tabs"
        And I should see the test page "test-page2" as tab 0 on the tab list "pinned-tabs"
        And I should see the test page "test-page1" as tab 1 on the tab list "pinned-tabs"
    ...
    Scenario: Only move targets and move cancel button should be clickable when they are visible
        ...
        And I click on the tab context menu move button of the tab 1 on the tab list "opened-tabs"
    ...
    Scenario: Clicking on the title of a moved tab should focus its associated opened tab
        ...
        Then I should see the test page "test-filter1" as tab 1 on the tab list "opened-tabs"
    ...
    Scenario: Clicking on the title of a moved pinned tab should focus its associated opened tab
        ...
        And I pin the tab 2
        And I pin the tab 3
        And I click on the tab context menu move button of the tab 2 on the tab list "pinned-tabs"
        And I click on the move above button of the tab 1 on the tab list "pinned-tabs"

        Then I should see the test page "test-filter1" as tab 1 on the tab list "pinned-tabs"

        When I click on the title of the tab 1 on the tab list "pinned-tabs"
    ...
    Scenario: Move mode should not be impacted when an opened tab is moved from the browser
        ...
        Then I should see the test page "test-page1" as tab 3 on the tab list "opened-tabs"

        When I click on the move above button of the tab 2 on the tab list "opened-tabs"
