...
Feature: Opened Tab List - Tag Management
    ...
    Scenario: Clicking on a tab context menu manage tags button should open the tag management view
        ...
        Then I should see the tab tag assignment view
        And I should see 2 visible tags in the tab tag assignment view
        And I should see the tag 0 with the label "qwerty" in the tab tag assignment view
        And I should see the tag 0 with the color 0 in the tab tag assignment view
        And I should see the tag 1 with the label "Yellow" in the tab tag assignment view
        And I should see the tag 1 with the color 3 in the tab tag assignment view
    ...
    Scenario: Clicking on an unchecked tag should add it to an opened tab
        ...
        Then the tag 0 in the tab tag assignment view should be unchecked
        And the tag 1 in the tab tag assignment view should be checked
    ...
    Scenario: Clicking on a checked tag should remove it from an opened tab
        ...
        Then the tag 1 in the tab tag assignment view should be checked

        When I click on the tag 1 checkbox in the tab tag assignment view
        And I click on the tab tag assignment back button
        And I click on the tab context menu manage tags button of the tab 1 on the tab list "opened-tabs"

        Then the tag 0 in the tab tag assignment view should be unchecked
        And the tag 1 in the tab tag assignment view should be unchecked
    ...
    Scenario: Creating a tag should add it to the tag list
        ...
        And I should see 3 visible tags in the tab tag assignment view
        And I should see the tag 0 with the label "azerty" in the tab tag assignment view
        And I should see the tag 0 with the color 0 in the tab tag assignment view
        And the tag 0 in the tab tag assignment view should be unchecked
        And I should see the tag 1 with the label "qwerty" in the tab tag assignment view
        And I should see the tag 1 with the color 0 in the tab tag assignment view
        And the tag 1 in the tab tag assignment view should be unchecked
        And I should see the tag 2 with the label "Yellow" in the tab tag assignment view
        And I should see the tag 2 with the color 3 in the tab tag assignment view
        And the tag 2 in the tab tag assignment view should be unchecked
    ...
    Scenario: A tag should be checked when all selected tabs have the tag
        ...
        Then the tag 0 in the tab tag assignment view should be checked
    ...
    Scenario: A tag should be indeterminate when some selected tabs have the tag
        ...
        Then the tag 0 in the tab tag assignment view should be indeterminate
    ...
    Scenario: Clicking on an unchecked tag should add it to selected tabs
        ...
        And the tag 0 in the tab tag assignment view should be checked
