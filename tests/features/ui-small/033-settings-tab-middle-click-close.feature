...
Feature: Settings - Tab middle click close
    ...
    Scenario: A middle click on a tab should close it
        ...
        When I middle click on the tab 1 on the workspace "opened-tabs"
    ...
    Scenario: A middle click on a pinned tab should close it
        ...
        When I middle click on the tab 0 on the workspace "pinned-tabs"

        Then I should see 0 visible tab on the workspace "pinned-tabs"
        And I should see 1 visible tab on the workspace "opened-tabs"
    ...
    Scenario: Uncheck tab middle click close setting should disable tab middle click close
        ...
        And I middle click on the tab 1 on the workspace "opened-tabs"

        Then I should see 3 visible tabs on the workspace "opened-tabs"

        When I open the test page "test-page2"
        And I middle click on the tab 3 on the workspace "opened-tabs"
    ...
    Scenario: Uncheck tab middle click close setting should disable pinned tab middle click close
        ...
        When I focus the small UI
        And I middle click on the tab 0 on the workspace "pinned-tabs"

        Then I should see 1 visible tab on the workspace "pinned-tabs"

        When I open the test page "test-page2"
        And I pin the tab 3
        And I middle click on the tab 1 on the workspace "pinned-tabs"
    ...
    Scenario: Check tab middle click close setting should enable tab middle click close
        ...
        When I open the test page "test-page2"
        And I middle click on the tab 2 on the workspace "opened-tabs"
